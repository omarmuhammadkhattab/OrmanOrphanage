	...
	<body>
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li>
								<div>
					<span><a class="btn btn-primary btn-lg" href="Login.html">Login</a></span>
				</div>
							</li>
                            <li>
								<div>
					               <span><a href="Sign%20up.html">Sign Up</a></span>
				                </div>
							</li>
        ...
        <form action="reportcontroller.php" method="POST">
            <select name="Report" id="Report">
                ...
                <option value="ReportOrphane" onclick="OrphanOption()">Orphan Report</option>
            </select> 
        ...
        <script>
                ...
                {
                    document.getElementById("EmployeesOption").style.display = 'none';
                ...
                function OrphanOption()
                {
                    ...
                    document.getElementById("EmployeesOption").style.display = 'none';
                    document.getElementById("DonationOption").style.display = 'none';
                }
        </script>
			</div>
					...
					<div class="col-md-4">
						...
						<div class="feature-left">
							...
							<div class="feature-copy">
								...
								<p><a href="Login.html">Learn More</a></p>
							</div>
						</div>
